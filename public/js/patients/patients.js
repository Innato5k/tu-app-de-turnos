...
const CREATE_PATIENT_URL = 'patients.create'; // Ruta para crear un nuevo paciente
const EDIT_PATIENT_BASE_URL = 'patients'; // Base para la URL de edición (ej. /patients/1/edit)
const DELETE_PATIENT_BASE_URL = 'patients'; // Base para la URL de eliminación (ej. /patients/1/delete)
    ...
    patients.forEach(patient => {
        ...
        row.innerHTML = `
                    ...
                    <td class="py-3 px-4 text-center">
                        <a href="${EDIT_PATIENT_BASE_URL}/${patient.id}/edit" class="btn btn-sm btn-info text-white fw-semibold" data-toggle="tooltip" data-placement="right" title="Editar Paciente">
                            ✎ 
                        </a>
                        <a href="${DELETE_PATIENT_BASE_URL}/${patient.id}/delete" class="btn btn-sm btn-danger text-white fw-semibold" data-toggle="tooltip" data-placement="right" title="Borrar Paciente">
                            🗑
                        </a>
                    </td>
                `;
