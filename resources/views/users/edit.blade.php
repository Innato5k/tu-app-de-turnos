...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-2">
        <h1 class="fs-3 fw-bold text-dark">Editar Usuario</h1>
        ...
        <div class="card-body">
            <form id="edituserForm">
                ...
                <div class="row d-flex justify-content-between mb-1">                    
                    <div class="col-md-3 ">
                        <label for="role" class="form-label text-dark small">Rol</label>
                        <select id="role" name="role" class="required form-select form-select-sm border-secondary">
                            <option value="" selected disabled>Seleccione una opción</option>
